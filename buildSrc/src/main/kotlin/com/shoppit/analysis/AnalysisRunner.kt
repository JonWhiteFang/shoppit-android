...
import com.shoppit.analysis.core.*
import com.shoppit.analysis.reporting.ReportGeneratorImpl
import com.shoppit.analysis.baseline.BaselineManagerImpl
import com.shoppit.analysis.integration.DetektIntegrationImpl
...
class AnalysisRunner(
    ...
    fun runAnalysis(): AnalysisResult {
        ...
        println("  Critical:          ${byPriority[com.shoppit.analysis.models.Priority.CRITICAL]?.size ?: 0}")
        println("  High:              ${byPriority[com.shoppit.analysis.models.Priority.HIGH]?.size ?: 0}")
        println("  Medium:            ${byPriority[com.shoppit.analysis.models.Priority.MEDIUM]?.size ?: 0}")
        println("  Low:               ${byPriority[com.shoppit.analysis.models.Priority.LOW]?.size ?: 0}")
        println()
    ...
    companion object {
         ...
         * Usage:
         * ```
         * java -cp ... com.shoppit.analysis.AnalysisRunner [options]
         * ```
         */
        @JvmStatic
