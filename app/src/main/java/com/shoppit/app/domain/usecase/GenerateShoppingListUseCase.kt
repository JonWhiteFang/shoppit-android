...
class GenerateShoppingListUseCase @Inject constructor(
    ...
    suspend operator fun invoke(): Result<Unit> {
        ...
        return try {
            ...
            val mealPlansResult = mealPlanRepository.getMealPlansForWeek(startDate, endDate)
                .first()
            
            if (mealPlansResult.isFailure) {
                return mealPlansResult.map { }
            }
            ...
            if (mealPlans.isEmpty()) {
                ...
                return shoppingListRepository.deleteAutoGeneratedItems()
            }
            ...
            // Get meal details
            val mealsResult = mealRepository.getMeals().first()
            
            if (mealsResult.isFailure) {
                return mealsResult.map { }
            }
            ...
            val deleteResult = shoppingListRepository.deleteAutoGeneratedItems()
            ...
            // Add new items
            return shoppingListRepository.addShoppingListItems(aggregatedItems)
                .map { 
